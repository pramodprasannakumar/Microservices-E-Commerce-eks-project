...
variable "ami_id" {
  ...
  type        = string
  default     = "ami-08982f1c5bf93d976" // Replace with the latest AMI ID for your region
}
...
variable "key_name" {
  ...
  type        = string
  default     = "us-east-1"       // create a keypair in the AWS console and provide the name here 
}
